...
- Home Page to view Premier League Rankings
- Detail Page to view Team Performance
- Filter function to search for particular team
- User can view each season data by chaning the year value. 
